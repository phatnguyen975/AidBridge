...
4. **Context Awareness:** Before implementing a feature, always refer to `AidBridge/docs/main/requirements.md` for business rules, `AidBridge/docs/main/tech_stack.md` for tool constraints, and `AidBridge/docs/main/project_structure.md` for architectural decisions.
