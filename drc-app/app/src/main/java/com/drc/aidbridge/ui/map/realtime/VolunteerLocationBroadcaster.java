...
public class VolunteerLocationBroadcaster {
    ...
    private static final String TAG = "VolunteerLocBroadcaster";
    ...
    public void broadcastManualLocation(double latitude, double longitude, float bearing) {
        if (!isBroadcasting) {
            return;
        }
        broadcastHelper.broadcastLocation(latitude, longitude, bearing);
    }

    public void broadcastEncodedRoute(@NonNull String polyline) {
        if (!isBroadcasting) {
            return;
        }
        broadcastHelper.broadcastRoute(polyline);
    }
