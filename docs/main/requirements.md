...
**3.6. Lịch sử nhiệm vụ & Thống kê:** Lịch sử chi tiết: Xem lại danh sách các ca cứu trợ đã hoàn thành. Bảng thành tích (Impact Dashboard) hiển thị số nhiệm vụ đã hoàn thành.
...
**4.1. Đăng ký lịch gửi hàng cứu trợ:** Mạnh thường quân chọn loại hàng muốn gửi bằng checklist gồm 5 nhóm item hệ thống quy định, chọn một Trạm trung chuyển (Hub) và ngày dự kiến sẽ mang hàng đến Hub.

**4.2. Quản lý ký gửi & Chọn trạm:** Hệ thống lưu thông tin ký gửi gồm Sponsor, Hub nhận hàng, danh sách loại item đã chọn và ngày dự kiến gửi hàng.

**4.3. Quy trình Ký gửi hàng:** Sau khi đăng ký, Backend tạo mã QR định danh yêu cầu ký gửi. Mạnh thường quân mang hàng đến Hub và đưa mã QR cho Staff quét để xác nhận đã nhận hàng.

**4.4. Thống kê:** Bảng tổng kết đóng góp và hệ thống vinh danh (huy hiệu, điểm tích lũy).

### 5. Phân hệ người dùng Quản lý trạm - Staff

**5.1. Quản lý nhận hàng & nhập kho:** Staff quét mã QR của Mạnh thường quân để xác nhận đã nhận hàng thành công. Việc nhập kho không tự động theo QR; Staff kiểm tra hàng thực tế rồi tự nhập số lượng vào kho bằng chức năng nhập kho riêng.
...
1. **Đăng ký lịch gửi hàng:** Mạnh thường quân chọn loại hàng muốn gửi bằng checklist 5 nhóm item cố định: Thuốc/Vật tư y tế, Quần áo/Chăn màn, Thức ăn, Nước uống, Khác. Người dùng chọn Hub sẽ gửi hàng và ngày dự kiến mang hàng đến Hub.
2. **Lưu yêu cầu ký gửi:** Backend lưu Sponsor, Hub nhận hàng, danh sách loại item đã chọn, ngày dự kiến gửi hàng và trạng thái chờ bàn giao.
3. **Tạo mã Ký gửi (Donation QR):** Backend cấp một mã QR định danh duy nhất cho yêu cầu ký gửi. QR chỉ dùng để xác minh yêu cầu ký gửi, không dùng để tự động cộng tồn kho.
4. **Tự động xóa yêu cầu quá hạn:** Nếu quá ngày dự kiến mà Staff chưa quét QR xác nhận đã nhận hàng, hệ thống tự động xóa yêu cầu ký gửi đó.
5. **Bàn giao và Kiểm tra:** Mạnh thường quân mang hàng đến Hub. Nhân viên trực trạm (Staff) kiểm tra hàng hóa thực tế.
6. **Xác nhận nhận hàng:** Staff dùng ứng dụng quét mã QR của Mạnh thường quân để xác nhận Hub đã nhận hàng thành công.
7. **Nhập kho thủ công:** Sau khi nhận hàng, Staff tự nhập số lượng, đơn vị và loại hàng thực tế vào kho bằng chức năng nhập kho riêng. Hệ thống không tự động cộng kho chỉ vì QR đã được quét.
8. **Hoàn tất:** Mạnh thường quân nhận được thông báo Hub đã xác nhận nhận hàng thành công.
...
- **Hoàn thành:** "Đơn cứu trợ đã hoàn tất. Cảm ơn bạn đã sử dụng hệ thống".
...
- **Xác nhận ký gửi:** "Mã QR ký gửi hàng hóa của bạn đã được tạo. Vui lòng mang hàng đến Trạm [Tên] vào ngày [Ngày dự kiến]".
- **Nhận hàng thành công:** "Nhân viên trực trạm đã xác nhận nhận hàng của bạn. Cảm ơn tấm lòng của bạn".

4. Thông báo dành cho nhân viên trực trạm

- **Sắp có hàng ký gửi:** "Mạnh thường quân [Tên] dự kiến mang hàng đến trạm vào ngày [Ngày dự kiến]. Vui lòng quét QR khi nhận hàng".
