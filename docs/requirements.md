...
- Nhập tên, số điện thoại, chọn nhu yếu phẩm và nhập số lượng người (Người lớn, Người già, Trẻ em). Số lượng vật phẩm tự động tính bằng số người.
...
- Nhập thông tin người cần cứu trợ (Họ tên, địa chỉ, mô tả nhà, tình trạng sức khỏe, số lượng người) và thông tin người gửi.
...
- Xem lại lịch sử các yêu cầu đã gửi (trong vòng 7 ngày gần nhất ngay cả khi đã offline).
...
- Thông tin nạn nhân: Tên, SĐT, Ghi chú vị trí.

**3.3. Bản đồ điều hướng:** Hiển thị đường đi đã tối ưu.

**3.4. Chatbox:** Chat trực tiếp với Nạn nhân.
...
**3.6. Lịch sử nhiệm vụ & Thống kê:** Lịch sử chi tiết: Xem lại danh sách các ca cứu trợ đã hoàn thành. Bảng thành tích (Impact Dashboard) hiển thị số người đã cứu, số kg thực phẩm, quãng đường, và điểm uy tín (Rating).

**3.7. Lưu trữ & Đồng bộ Offline:** Cho phép tải trước bản đồ của khu vực.

**3.8. List nạn nhân gần nhất:** Hệ thống đề xuất list các nạn nhân cần cứu gần nhất để TNV chủ động chọn.

### 4. Phân hệ người dùng Mạnh thường quân - Sponsor

**4.1. Đăng ký hàng cứu trợ:** Nhập thông tin hàng, danh mục, số lượng.

**4.2. Quản lý ký gửi & Chọn trạm:** Smart Hub Selection tự động đề xuất trạm gần nhất đang thiếu hụt hàng.

**4.3. Quy trình Ký gửi hàng:** Tạo mã QR, bàn giao tại trạm, nhận thông báo xác nhận.

**4.4. Thống kê:** Bảng tổng kết đóng góp và hệ thống vinh danh (huy hiệu, điểm tích lũy).

### 5. Phân hệ người dùng Quản lý trạm - Staff

**5.1. Quản lý nhập kho:** Quét mã QR của Sponsor, tự động cộng số lượng vật phẩm vào trạm.

**5.2. Quản lý Xuất kho:** Quét mã QR của TNV, thực hiện Atomic Inventory Update (trừ số lượng realtime).
...
**6.2. Quản lý Mạng lưới Trạm trung chuyển:** Khởi tạo vị trí, thiết lập danh mục nhận hàng, cài đặt ngưỡng "Tồn kho thấp".
...
- **Bước 1:** Tiếp nhận yêu cầu, xác định Vị trí, loại hàng, và AI Priority.
...
Công thức tính Priority Score ($S$):
